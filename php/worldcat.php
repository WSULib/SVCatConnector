...
$url = "http://www.worldcat.org/webservices/catalog/search/sru?query=$query+and+srw.li+%3D+%22EYW&servicelevel=full&wskey=$wskey&sortKeys=Date,,0+relevance";
...
foreach($wxml->xpath('//wc:record') as $record) {
	...
	$link = "http://www.wild.worldcat.org/oclc/$oclcnum";
